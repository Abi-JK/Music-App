  ...
  return (
    <div className="settings-screen" style={{ paddingBottom: 120 }}>
      <div style={{ padding: '20px 20px 4px' }}>
        <h2 style={{ margin: 0, fontSize: 22, color: 'var(--text)', fontWeight: 800 }}>⚙️ Settings</h2>
        <p style={{ margin: '6px 0 0', fontSize: 12, color: 'var(--text-dim)', lineHeight: 1.5 }}>
          Backup & restore your data, fix background playback, and manage downloads.
          Your data is safe in the cloud even if Chrome data is cleared.
        </p>
      </div>
