...
export async function searchArtistSongs(artistName, limit = 200) {
    ...
    if (artists.length > 0) {
      for (const artist of artists.slice(0, 3)) {
        ...
        if (rawSongs.length > 0) {
          ...
          if (noAudio.length > 0) {
            const enriched = await batchEnrichSongs(noAudio.slice(0, 50));
            addSongs(enriched);
          }
        }
      }
  ...
  const fallbackQueries = [
    `${artistName} songs`, `${artistName} hits`,
    `${artistName} tamil`, `${artistName} hindi`,
    `${artistName} kannada`, `${artistName} telugu`,
    `${artistName} malayalam`, `${artistName} bengali`,
    `${artistName} old songs`, `${artistName} romantic`,
    `${artistName} film songs`, `${artistName} 2024`,
  ];
  ...
  if (artistName.toLowerCase().includes('yesudas') || artistName.toLowerCase().includes('k.j. yesudas')) {
    fallbackQueries.push('K.J. Yesudas tamil', 'K.J. Yesudas hindi', 'K.J. Yesudas kannada',
      ...
      'K.J. Yesudas old', 'K.J. Yesudas classic');
  }
  ...
  if (artistName.toLowerCase().includes('ar rahman') || artistName.toLowerCase().includes('a.r. rahman')) {
    fallbackQueries.push('A.R. Rahman tamil', 'A.R. Rahman hindi', 'A.R. Rahman telugu',
      'A.R. Rahman kannada', 'A.R. Rahman romantic', 'A.R. Rahman hits');
  }
  if (artistName.toLowerCase().includes('pritam')) {
    fallbackQueries.push('Pritam hindi', 'Pritam romantic', 'Pritam 2024', 'Pritam hits');
  }
  if (artistName.toLowerCase().includes('anirudh')) {
    fallbackQueries.push('Anirudh tamil', 'Anirudh telugu', 'Anirudh kannada',
      'Anirudh hindi', 'Anirudh romantic', 'Anirudh hits');
  }
  if (artistName.toLowerCase().includes('shreya ghoshal') || artistName.toLowerCase().includes('shreya')) {
    fallbackQueries.push('Shreya Ghoshal tamil', 'Shreya Ghoshal hindi', 'Shreya Ghoshal telugu',
      'Shreya Ghoshal kannada', 'Shreya Ghoshal romantic', 'Shreya Ghoshal hits');
  }
  if (artistName.toLowerCase().includes('spb') || artistName.toLowerCase().includes('balasubrahmanyam')) {
    fallbackQueries.push('S.P. Balasubrahmanyam tamil', 'S.P. Balasubrahmanyam telugu',
      'S.P. Balasubrahmanyam kannada', 'S.P.B. classic', 'S.P.B. hits');
  }
  if (artistName.toLowerCase().includes('lata') || artistName.toLowerCase().includes('mangeshkar')) {
    fallbackQueries.push('Lata Mangeshkar hindi', 'Lata Mangeshkar classic',
      'Lata Mangeshkar romantic', 'Lata Mangeshkar hits', 'Lata Mangeshkar old songs');
  }
  if (artistName.toLowerCase().includes('kishore kumar')) {
    fallbackQueries.push('Kishore Kumar hindi', 'Kishore Kumar classic',
      'Kishore Kumar romantic', 'Kishore Kumar hits', 'Kishore Kumar old songs');
  }
