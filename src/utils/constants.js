...
export const LANG_SEARCH_QUERIES = {
  Tamil: [
    ...
    'MGR songs', 'Sivaji Ganesan songs', 'Ilaiyaraaja songs',
    'tamil 60s songs', 'tamil 70s songs', 'tamil 80s songs',
    'tamil 90s songs', 'MSV songs', 'Kannadasan songs',
  ],
  Hindi: [
...
export const HOME_SECTIONS = [
  ...
  { key: 'tamil60s',      label: '60s Tamil Classics',         query: 'tamil 1960s songs' },
  { key: 'tamil70s',      label: '70s Tamil Classics',         query: 'tamil 1970s songs' },
  { key: 'tamil80s',      label: '80s Tamil Classics',         query: 'tamil 1980s songs' },
  { key: 'hindi60s',      label: '60s Hindi Classics',         query: 'hindi 1960s songs' },
  { key: 'hindi70s',      label: '70s Hindi Classics',         query: 'hindi 1970s songs' },
  { key: 'hindi80s',      label: '80s Hindi Classics',         query: 'hindi 1980s songs' },
  { key: 'msvklassic',    label: 'M.S. Viswanathan Classics',  query: 'M.S. Viswanathan old tamil songs' },
  { key: 'kvmdclassic',   label: 'K.V. Mahadevan Classics',    query: 'K.V. Mahadevan tamil songs' },
  { key: 'gprclassic',    label: 'G. Ramanathan Classics',     query: 'G. Ramanathan tamil songs' },

  // ── MGR Hits ──
  { key: 'mgr',           label: 'MGR Hits',                   query: 'MGR tamil songs' },
  { key: 'mgrclassics',   label: 'MGR Classics',               query: 'M.G. Ramachandran songs' },
  { key: 'mgr_all',       label: 'All MGR Songs',              query: 'MGR hit songs tamil' },
  { key: 'mgr_old',       label: 'MGR Old Classics',           query: 'M.G. Ramachandran old songs' },
  { key: 'mgr_devotional', label: 'MGR Devotional',            query: 'MGR devotional songs' },
  { key: 'mgr_action',    label: 'MGR Action Songs',           query: 'MGR mass songs tamil' },
  ...
  { key: 'sivaji_all',    label: 'All Sivaji Songs',           query: 'Sivaji Ganesan hit songs' },
  { key: 'sivaji_old',    label: 'Sivaji Old Classics',        query: 'Sivaji Ganesan old tamil songs' },
...
export const INDIAN_ARTISTS = [
  ...
  { name: 'Jaishankar',             lang: 'Tamil' },
  { name: 'Ravichandran',           lang: 'Tamil' },
  { name: 'Sivakumar',              lang: 'Tamil' },
  { name: 'Bharathiraja',           lang: 'Tamil' },
  { name: 'K. Balachander',         lang: 'Tamil' },
  { name: 'Balu Mahendra',          lang: 'Tamil' },
  { name: 'G. Ramanathan',          lang: 'Tamil' },
  { name: 'K.V. Mahadevan',         lang: 'Tamil' },
  { name: 'Viswanathan-Ramamoorthy', lang: 'Tamil' },
  { name: 'T.K. Ramamoorthy',       lang: 'Tamil' },
  { name: 'T.R. Pappa',             lang: 'Tamil' },
  { name: 'Gantry Renga Raja',      lang: 'Tamil' },
  { name: 'Soolamangalam Sisters',  lang: 'Tamil' },
  { name: 'P.B. Sreenivas',         lang: 'Tamil' },
  { name: 'T.M. Soundararajan',     lang: 'Tamil' },
  { name: 'P. Susheela',            lang: 'Multi' },
  { name: 'S. Janaki',              lang: 'Multi' },
  { name: 'M.S. Subbulakshmi',      lang: 'Tamil' },
